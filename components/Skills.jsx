		...
		<div id='skills' className='w-full lg:h-screen p-2'>
			<div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
				...
				<div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
					<div
						className='p-6 flex justify-center items-center shadow-lg  dark:shadow-gray-600  border-2   rounded-xl hover:scale-105 ease-in duration-300 '
					>
					...
					<div className='p-6 flex justify-center items-center shadow-lg dark:shadow-gray-600  border-2 rounded-xl hover:scale-105 ease-in duration-300'>
						<div className='grid grid-cols-2 gap-4 justify-center items-center'>
							<div className='m-auto'>
					...
					<div className='p-6 flex justify-center items-center shadow-lg dark:shadow-gray-600  border-2 rounded-xl hover:scale-105 ease-in duration-300'>
						<div className='grid grid-cols-2 gap-4 justify-center items-center'>
							<div className='m-auto'>
								<Image src={vercel} alt='/' width='64px' height='64px' />
							</div>
							<div className='flex flex-col items-center justify-center'>
								<h3>Vercel</h3>
							</div>
					...
					<div className='p-6 flex justify-center items-center shadow-lg dark:shadow-gray-600  border-2 rounded-xl hover:scale-105 ease-in duration-300'>
						<div className='grid grid-cols-2 gap-4 justify-center items-center'>
							<div className='m-auto'>
								<Image src={netlify} alt='/' width='64px' height='64px' />
							</div>
							<div className='flex flex-col items-center justify-center'>
								<h3>Netlify</h3>
							</div>
					...
					<div className='p-6 flex justify-center items-center shadow-lg dark:shadow-gray-600  border-2 rounded-xl hover:scale-105 ease-in duration-300'>
						<div className='grid grid-cols-2 gap-4 justify-center items-center'>
							<div className='m-auto'>
								<Image src={heroku} alt='/' width='64px' height='64px' />
							</div>
							<div className='flex flex-col items-center justify-center'>
								<h3>Heroku</h3>
							</div>
					...
					<div className='p-6 flex justify-center items-center shadow-lg dark:shadow-gray-600  border-2 rounded-xl hover:scale-105 ease-in duration-300'>
						<div className='grid grid-cols-2 gap-4 justify-center items-center'>
							<div className='m-auto'>
								<Image src={postgre} alt='/' width='64px' height='64px' />
							</div>
							<div className='flex flex-col items-center justify-center'>
								<h3>PostgreSQL</h3>
							</div>
